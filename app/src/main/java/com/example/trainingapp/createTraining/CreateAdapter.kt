...
class CreateAdapter constructor(val exerciseListList:ArrayList<ExerciseList>, val context:Context) : RecyclerView.Adapter<CreateAdapter.CreateViewHolder>() {
   val chooseList:ArrayList<ExerciseList> = ArrayList()
    ...
    override fun onBindViewHolder(holder: CreateViewHolder, position: Int) {
        holder.bind(exerciseListList[position],chooseList)
    }
