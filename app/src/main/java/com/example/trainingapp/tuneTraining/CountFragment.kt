...
//                        Toast.makeText(context, "Поле не может быть равно 0", Toast.LENGTH_SHORT)
//                            .show()
//                        position = i
//                        donloadData(position)
//
...
//                        view.findNavController().navigate(R.id.queueFragment, bundle)
//
//                    }
//                }
//            }
